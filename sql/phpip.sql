...
CREATE TABLE `history` (  `date` datetime default NULL,  `id` mediumint(25) default '0',  `ip` varchar(36) NOT NULL default '',  `username` varchar(16) NOT NULL default '',  `hostaddress` varchar(16) NOT NULL default '',  UNIQUE KEY `date` (`date`),  KEY `id` (`id`,`username`,`date`),  KEY `hostaddress` (`hostaddress`),  KEY `ip` (`ip`)) ENGINE=MyISAM;

-- 
-- Table structure for table `ldap`
-- 

CREATE TABLE `ldap` (  `ldapId` mediumint(25) NOT NULL auto_increment,  `ldapConnect` varchar(255) NOT NULL default '',  `ldapPort` varchar(255) NOT NULL default '',  PRIMARY KEY  (`ldapId`)) ENGINE=MyISAM COMMENT='Ldap Connect statement';

-- 
-- Table structure for table `net_ips`
-- 

CREATE TABLE `net_ips` (  `AddressId` mediumint(25) NOT NULL auto_increment,  `netaddress` varchar(36) NOT NULL default '',  `ip_description` varchar(255) NOT NULL default '',  `view` mediumint(10) NOT NULL default '0',  `NetCidr` mediumint(10) NOT NULL default '0',  `groupid` mediumint(25) NOT NULL default '1',  PRIMARY KEY  (`AddressId`),  KEY `ip_description` (`ip_description`)) ENGINE=MyISAM;
...
CREATE TABLE `style` (  `styleID` mediumint(25) NOT NULL auto_increment,  `styleType` varchar(255) NOT NULL default '',  `styleName` varchar(255) NOT NULL default '',  PRIMARY KEY  (`styleID`)) ENGINE=MyISAM COMMENT='css style ';
...
CREATE TABLE `version` (  `phpip` char(20) NOT NULL default '',  KEY `phpip` (`phpip`) ) ENGINE=MyISAM;
